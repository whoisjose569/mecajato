...
def gerar_os(request, identificador):
    ...
    #pdf.output('os.pdf') salvar no projeto pra teste
    
    
    #coloque dentro do fileResponse as_attachment=True para baixar o pdf direto sem abrir outra pagina
    return FileResponse(pdf_bytes, filename=f"{servico.protocole}.pdf")
